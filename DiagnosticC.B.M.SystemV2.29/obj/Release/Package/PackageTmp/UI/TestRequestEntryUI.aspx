<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestRequestEntryUI.aspx.cs" Inherits="DiagnosticC.B.M.SystemV2._29.UI.TestRequestEntryUI" %>
...
<body>
    ...
    <h1>Test Request Entry</h1>
        ...
        <asp:TextBox ID="dateOfBirthTextBox" placeholder="yyyy-mm-dd" CssClass="textBox" runat="server"></asp:TextBox>
        <br/>
